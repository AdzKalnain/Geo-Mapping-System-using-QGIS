    <div class="container-fluid">
        <div class="card shadow">
            <div class="card-header py-3">
                <p class="text-primary m-0 font-weight-bold">New Service</p>
            </div>
            <div class="card-body">
                <h2>Service Form</h2>
                <p class="service-caption text-muted mt-1">Add new services that will rack you with customers</p>
                <form class="service-form" action="function/shop_function.php?function=add" method="POST">
                    <div class="row">
                        <div class="col-md-6">
                    ...
                    <button class="btn btn-secondary btn-submit mt-3 float-right" name="btn-submit" id="btn-add" value="Submit">Save</button>               
                </form>
            </div>
        </div>
    </div>
