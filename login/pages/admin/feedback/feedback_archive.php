            <div class="card-header py-3">
                <div class="feedback-dropdown d-flex justify-content-between">
                    <p class="text-secondary m-0 font-weight-bold">Feedback Info (All)</p>
            ...
            <div class="card-body">
                <div class="dash-feedback-cards">
                    <?php 
                        $query = mysqli_query($mysqli, "SELECT * FROM grave_feedback WHERE feedback_status = 'Archive'"); 
                    ...
                    <div class="card-single shadow mt-3">
                        ...
                        <div class="card-footer pb-4">
                            ...
                            <a href="<?php echo web_root; ?>pages/admin/function/feedback_function.php?feedbackid=<?php echo $row['feedback_id']; ?> & action=delete" class="float-right my-1">
                                <button type="button" class="btn btn-danger btn-sm ml-1">
                                    <span class="ti-trash" style="fill: blue;"></span>
                                </button>
                            </a>
